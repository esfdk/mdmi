...
/**
 * The DataLoader class is used to convert the string data loaded in from the text file
 * to Mushroom objects.
 * The DataLoader class makes use of the CSVFileReader class to accomplish this.
